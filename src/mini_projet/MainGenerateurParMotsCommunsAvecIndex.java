...
public class MainGenerateurParMotsCommunsAvecIndex {
    ...
    public static void main(String[] args) {
        ...
        List<Nom> liste2 = Arrays.asList(nom2, nom3, nom4, nom5); // indexée

        // Création du générateur
        GenerateurParMotsCommunsAvecIndex generateur = new GenerateurParMotsCommunsAvecIndex(1);
        generateur.construireIndex(liste2);

        // Affichage de l'index
        System.out.println("Index par nombre de mots :");
        for (Map.Entry<Integer, List<Nom>> entry : generateur.getIndex().entrySet()) {
            System.out.print("Nombre de mots = " + entry.getKey() + " => ");
